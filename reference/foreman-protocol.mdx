...
description: "Low-Cost Tool Execution via Worker Models and Self-Describing MCP — a novel architecture for reducing cloud API costs from agent tool execution."
...
| **Model used** | Embedding model (e.g. `nomic-embed-text`) | Any cheap model (local or cloud) |
