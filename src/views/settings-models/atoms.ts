...
export const TIER_LABELS: Record<string, Record<string, string>> = {
  ...
  google: {
    'gemini-3.1-pro': 'Flagship — most advanced, complex agentic workflows',
    'gemini-3-deep-think': 'Deep reasoning — science, research, engineering',
    'gemini-3-flash': 'Frontier speed — agentic workflows, high volume',
