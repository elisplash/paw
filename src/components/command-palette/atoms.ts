...
const VIEW_ENTRIES: { key: string; label: string; icon: string; shortcut?: string }[] = [
  ...
  { key: 'integrations', label: 'Integrations', icon: '🔗', shortcut: '5' },
  { key: 'mail', label: 'Mail', icon: '📧', shortcut: '6' },
  { key: 'channels', label: 'Channels', icon: '📡', shortcut: '7' },
  { key: 'skills', label: 'Skills', icon: '📖', shortcut: '8' },
