...
:::tip
Memory content itself is stored unencrypted in SQLite for fast full-text search (BM25). If you need encrypted memory content at rest, use the container sandbox with an encrypted filesystem.
:::
