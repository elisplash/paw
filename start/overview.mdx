---
title: "Overview"
description: "The open-source AI agent OS — 400+ integrations, multi-agent, multi-channel, fully local, infinitely extensible."
...
- **400+ integrations out of the box** — productivity, dev tools, cloud, CRM, media, smart home, trading, security, AI/ML, and more — every one ships ready to use
...
| **Built-in integrations** | 400+ | Limited plugins | ~20 | ~15 / code-defined |
