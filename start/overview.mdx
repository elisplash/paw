...
<Note>
**OpenPawz is not a chatbot.** It's an AI agent operating system that runs on your desktop — with 400+ integrations, 11 chat channels, multi-agent orchestration, and zero cloud dependency.
</Note>
...
<Columns cols={3}>
  <Card title="400+ integrations" icon="puzzle">
    Productivity, dev tools, cloud, CRM, media, IoT, trading, security, AI/ML — all ship ready to use. No plugins to install.
  </Card>
...
| **Built-in integrations** | 400+ | Limited plugins | ~15 / code-defined |
