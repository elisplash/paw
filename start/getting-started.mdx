...
<Tabs>
  ...
  <Tab title="What's different?">
    ...
    - **Multi-chain DeFi trading** — Coinbase + Solana (Jupiter/Pump.fun) + Ethereum (Uniswap) with configurable policy guardrails
    - **Hybrid semantic memory** — BM25 + vector + MMR + temporal decay. The most advanced retrieval in any agent platform
    ...
    - **75+ built-in tools** — Email, GitHub, trading, browser, shell, TTS, crypto — not plugins, *built in*
