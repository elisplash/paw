...
<Tabs>
  ...
  <Tab title="What's different?">
    ...
    - **25,000+ integrations** — 400+ native built-in, plus 25,000+ community node types via the MCP Bridge to n8n — all discoverable and auto-installable at runtime
...
<Columns cols={2}>
  <Card title="25,000+ integrations" icon="puzzle">
    400+ native integrations built in, plus 25,000+ community node types via the MCP Bridge to n8n. Agents discover and auto-install integrations at runtime — zero configuration.
  </Card>
