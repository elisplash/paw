---
title: "OpenPawz"
description: "Your AI, your rules. The open-source AI agent OS with 400+ integrations — private, powerful, extensible."
...
The open-source AI agent OS built on [Tauri v2](https://v2.tauri.app/). Create autonomous agents with **400+ integrations out of the box**, connect them to 11 chat platforms, and run everything locally on your machine. No cloud, no open ports, no Node.js backend.
...
<Columns cols={2}>
  <Card title="400+ integrations" icon="puzzle">
    Productivity, dev tools, cloud, CRM, media, smart home, trading, security, and more. Every integration ships ready — configure credentials and assign to agents.
  </Card>
