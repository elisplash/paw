...
<Columns cols={3}>
  <Card title="Community integrations" icon="puzzle">
    400+ native built-in, plus community integrations via the MCP Bridge to n8n — all discoverable and auto-deployable by your agents at runtime.
  </Card>
