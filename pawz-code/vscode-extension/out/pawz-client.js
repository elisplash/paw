...
exports.PawzCodeClient = void 0;
class PawzCodeClient {
    constructor(baseUrl, authToken) {
        this.baseUrl = baseUrl;
        this.authToken = authToken;
    }
    async streamChat(req, onEvent, signal, onRunId) {
        ...
        if (!body)
            throw new Error('Empty response from pawz-code server');
...
exports.PawzCodeClient = PawzCodeClient;
//# sourceMappingURL=pawz-client.js.map
